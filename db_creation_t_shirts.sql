...
BEGIN
    ...
    DECLARE brand VARCHAR(20);  -- Changed to VARCHAR to store brand
    DECLARE color VARCHAR(10);  -- Changed to VARCHAR to store color
    DECLARE size VARCHAR(5);    -- Changed to VARCHAR to store size
    DECLARE price INT;
    DECLARE stock INT;
